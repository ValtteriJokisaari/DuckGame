...
def lataa_kuvat(polku):
    ...
    kuvat["laatikko"] = pyglet.resource.image("laatikko.png")
    kuvat["aita"] = pyglet.resource.image("aita.png")
    kuvat["taustakuva"] = pyglet.resource.image("tausta.png")
    kuvat["menukuva"] = pyglet.resource.image("menukuva.png")
    kuvat["mato"] = pyglet.resource.image("mato.png")
    kuvat["matokuollut"] = pyglet.resource.image("matokuollut.png")
    kuvat["piste"] = pyglet.resource.image("piste.png")
